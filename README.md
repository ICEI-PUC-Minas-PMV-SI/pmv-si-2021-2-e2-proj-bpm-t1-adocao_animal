...
Possibilitar o cadastro dos dados de pessoas interessadas em adotar animais, caracterizadas como adotante. As informações do adotante serão disponibilizadas pela própria pessoa.
Dispor na plataforma os dados do adotante aprovado (aceitação do formulário de adoção com requisitos mínimos) pela ONG ou pelo abrigo e do animal disponível para adoção, assim o adotante pode escolher o animal sem precisar se deslocar por diversos locais.
Proporcionar para as ONGs e abrigos e, quando necessário, para as clínicas veterinárias ou veterinários voluntários, o controle dos animais que foram adotados, utilizando os dados que estão armazenados.
...
### 2 PARTICIPANTES DO PROCESSO DE NEGÓCIO <a name="4"></a>
...
### 3 MODELAGEM DO PROCESSO DE NEGÓCIO <a name="5"></a>

### 3.1 ANÁLISE DA SITUAÇÃO ATUAL (AS-IS) <a name="6"></a>
...
### 3.1.1 Processo de Cadastro de Animais (AS-IS) <a name="7"></a>
...
### 3.1.2 Processo de Cadastro de Clínicas Veterinárias Parceiras e Veterinários Voluntários (AS-IS) <a name="8"></a>
...
### 3.1.3 Processo de Cadastro de Adotantes (AS-IS) <a name="9"></a>
...
### 3.1.4 Processo de Adoção (AS-IS) <a name="10"></a>
...
### 3.1.5 Processo de Pós-Adoção (AS-IS) <a name="11"></a>
...
### 3.2 MODELAGEM DOS PROCESSOS APRIMORADOS (TO-BE) <a name="12"></a>
...
### 3.2.1 Processo de Cadastro de ONG e Abrigo (TO-BE) <a name="13"></a>
...
### 3.2.2 Processo de Cadastro de Clínicas Veterinárias Parceiras e Veterinários Voluntários (TO-BE) <a name="14"></a>
...
### 3.2.3 Processo de Cadastro de Animais (TO-BE) <a name="15"></a>
...
### 3.2.4 Processo de Cadastro de Adotantes (TO-BE) <a name="16"></a>
...
### 3.2.5 Processo de Adoção (TO-BE) <a name="17"></a>
...
### 3.2.6 Processo de Pós-Adoção (TO-BE) <a name="18"></a>
...
### 4 PROJETO DA ARQUITETURA DE DADOS DA SOLUÇÃO PROPOSTA <a name="19"></a>

### 4.1 DIAGRAMA DE ENTIDADES E RELACIONAMENTOS (DER) <a name="20"></a>

Figura 12 - Diagrama de Entidades e Relacionamentos

Fonte: Os autores.

### 4.2 IMPACTOS DA IMPLEMENTAÇÃO EM UM BANCO DE DADOS NOSQL <a name="21"></a>
...
### 4.3 MODELO RELACIONAL <a name="22"></a>
...
### 4.4 ESBOÇO DE CONSULTAS COM SQL DE ACORDO COM AS NECESSIDADES DOS PARTICIPANTES DO PROCESSO <a name="23"></a>
...
### 5 RELATÓRIOS ANALÍTICOS <a name="24"></a>
...
### 5.1 ASSOCIAÇÃO DE COMANDOS SQL COM RELATÓRIOS ANALÍTICOS <a name="25"></a>
...
### 6 INDICADORES DE DESEMPENHO <a name="26"></a>
